        ...
        <div className="mt-10 border-t border-slate-200 pt-8">
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-3 text-sm text-slate-500">
            <div className="flex items-center gap-2">
              ...
              <a href="https://maps.google.com/?q=18+Lower+Baggot+Street+Dublin+2+Ireland" target="_blank" rel="noopener noreferrer" className="hover:text-slate-700 transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="mailto:support@lumenbridge.example" className="hover:text-slate-700 transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+35315318420" className="hover:text-slate-700 transition-colors">
                +353 1 531 8420
              </a>
            </div>
          </div>
