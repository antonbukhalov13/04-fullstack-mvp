      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-sm text-slate-500">
            ...
            Finance Ltd (далее — «Компания») в соответствии с применимым
            европейским законодательством, включая GDPR, а также иными
            нормативными актами.
          </p>
          ...
          <p className="mt-3 text-sm text-slate-600 leading-relaxed">
            ...
            (чувствительные данные), за исключением случаев, прямо предусмотренных
            законодательством.
          </p>
          <p className="mt-3 text-sm text-slate-600 leading-relaxed">
            Предоставление персональных данных является добровольным, однако без
            их предоставления обработка заявки или оказание услуг может быть
            невозможна.
          </p>
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-600">
            ...
            <li>
              законных интересов Компании, включая предотвращение мошенничества и
              управление рисками.
            </li>
          </ul>
          ...
          <p className="mt-3 text-sm text-slate-600 leading-relaxed">
            Передача осуществляется с соблюдением требований законодательства о
