...
Prompt: Форма заявки и контакты

1. Центрировать ссылки «Подать ещё одну заявку» и «В личный кабинет» после успешной отправки на /apply
2. Поменять местами треугольники (сверху — вверх, снизу — вниз) в кастомном Select
3. Добавить красную кнопку «Удалить» для загруженного файла в форме Свяжитесь с нами
